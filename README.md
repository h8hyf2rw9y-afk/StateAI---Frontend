...
Este repositorio contiene el **frontend** del proyecto (la interfaz de usuario). El backend vive en un repositorio separado ([StateAI - Backend](https://github.com/h8hyf2rw9y-afk/StateAI---Backend)).
...
🚧 Este frontend está en fase inicial — el repositorio aún no contiene código. Este README sirve como punto de partida y se irá completando a medida que se defina la arquitectura.

## Stack tecnológico

_TODO: aún no definido._

## Estructura del proyecto

_TODO: se documentará una vez definida la arquitectura (por ejemplo, framework, gestión de estado, componentes, estilos, etc.)._
